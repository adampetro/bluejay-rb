...
#   end
#
# source://rake//lib/rake/packagetask.rb#45
class Rake::PackageTask < ::Rake::TaskLib
  ...
  # @yield [_self]
  # @yieldparam _self [Rake::PackageTask] the object that the method was called on
  #
  # source://rake//lib/rake/packagetask.rb#89
  def initialize(name = T.unsafe(nil), version = T.unsafe(nil)); end

  # Create the tasks defined by this task library.
  #
  # source://rake//lib/rake/packagetask.rb#112
  def define; end

  # Initialization that bypasses the "yield self" and "define" step.
  #
  # source://rake//lib/rake/packagetask.rb#96
  def init(name, version); end

  # Name of the package (from the GEM Spec).
  #
  # source://rake//lib/rake/packagetask.rb#47
  def name; end
  ...
  # false).
  #
  # source://rake//lib/rake/packagetask.rb#57
  def need_tar; end
  ...
  #
  # source://rake//lib/rake/packagetask.rb#65
  def need_tar_bz2=(_arg0); end

  # True if a gzipped tar file (tar.gz) should be produced (default
  # is false).
  #
  # source://rake//lib/rake/packagetask.rb#61
  def need_tar_gz; end
  ...
  #
  # source://rake//lib/rake/packagetask.rb#61
  def need_tar_gz=(_arg0); end

  # True if a xz'd tar file (tar.xz) should be produced (default is false)
  #
  # source://rake//lib/rake/packagetask.rb#68
  def need_tar_xz; end

  # True if a xz'd tar file (tar.xz) should be produced (default is false)
  #
  # source://rake//lib/rake/packagetask.rb#68
  def need_tar_xz=(_arg0); end

  # True if a zip file should be produced (default is false)
  #
  # source://rake//lib/rake/packagetask.rb#71
  def need_zip; end

  # True if a zip file should be produced (default is false)
  #
  # source://rake//lib/rake/packagetask.rb#71
  def need_zip=(_arg0); end

  # Directory used to store the package files (default is 'pkg').
  #
  # source://rake//lib/rake/packagetask.rb#53
  def package_dir; end

  # Directory used to store the package files (default is 'pkg').
  #
  # source://rake//lib/rake/packagetask.rb#53
  def package_dir=(_arg0); end

  # The directory this package will be built in
  #
  # source://rake//lib/rake/packagetask.rb#178
  def package_dir_path; end

  # List of files to be included in the package.
  #
  # source://rake//lib/rake/packagetask.rb#74
  def package_files; end

  # List of files to be included in the package.
  #
  # source://rake//lib/rake/packagetask.rb#74
  def package_files=(_arg0); end

  # The name of this package
  #
  # source://rake//lib/rake/packagetask.rb#172
  def package_name; end

  # The package name with .tar.bz2 added
  #
  # source://rake//lib/rake/packagetask.rb#196
  def tar_bz2_file; end

  # Tar command for gzipped or bzip2ed archives.  The default is 'tar'.
  #
  # source://rake//lib/rake/packagetask.rb#77
  def tar_command; end

  # Tar command for gzipped or bzip2ed archives.  The default is 'tar'.
  #
  # source://rake//lib/rake/packagetask.rb#77
  def tar_command=(_arg0); end

  # The package name with .tar.gz added
  #
  # source://rake//lib/rake/packagetask.rb#190
  def tar_gz_file; end

  # The package name with .tar.xz added
  #
  # source://rake//lib/rake/packagetask.rb#202
  def tar_xz_file; end

  # target directory relative to working_dir
  #
  # source://rake//lib/rake/packagetask.rb#217
  def target_dir; end

  # The package name with .tgz added
  #
  # source://rake//lib/rake/packagetask.rb#184
  def tgz_file; end

  # Version of the package (e.g. '1.3.2').
  #
  # source://rake//lib/rake/packagetask.rb#50
  def version; end
  ...
  #
  # source://rake//lib/rake/packagetask.rb#83
  def without_parent_dir; end

  # True if parent directory should be omited (default is false)
  #
  # source://rake//lib/rake/packagetask.rb#83
  def without_parent_dir=(_arg0); end

  # source://rake//lib/rake/packagetask.rb#212
  def working_dir; end

  # Zip command for zipped archives.  The default is 'zip'.
  #
  # source://rake//lib/rake/packagetask.rb#80
  def zip_command; end

  # Zip command for zipped archives.  The default is 'zip'.
  #
  # source://rake//lib/rake/packagetask.rb#80
  def zip_command=(_arg0); end

  # The package name with .zip added
  #
  # source://rake//lib/rake/packagetask.rb#208
  def zip_file; end
end
